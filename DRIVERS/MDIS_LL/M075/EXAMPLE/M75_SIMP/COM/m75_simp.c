 ...
 *
 * $Log: m75_simp.c,v $
 * Revision 1.4  2009/07/14 17:47:18  cs
 * R:1. Porting to MDIS5
 * M:1. use MDIS_PATH for MDIS paths
 *
 * Revision 1.3  2004/08/31 12:14:45  cs
 * made usage more clear,
 * added safety handling for M75_MAX_FRAME_SIZE and M75_MAX_FRAME_NUM SetStats
 * added M_MK_IRQ_ENABLE and M75_IRQ_ENABLE SetStats
 *
 * Revision 1.2  2004/08/10 10:10:22  cs
 * removed typo in getstat print (M75_SCC_REGS)
 *
 * Revision 1.1  2004/08/06 11:20:29  cs
 * Initial Revision
 *
 *---------------------------------------------------------------------------
